...
//PIN CONNECTIONS
#define ADS_DRDY_PIN	6	// ADS data ready pin
#define ADS_DRDY_PORT	2	// ADS data ready port

#define ADS_RST_PIN	    14	// ADS reset pin
#define ADS_RST_PORT	5	// ADS reset port

#define ADS_START_PIN	12	// ADS start pin
#define ADS_START_PORT	5	// ADS start port

#define BOARD_ADS_PIN	13 //Master ADS chip select pin
#define BOARD_ADS_PORT  5  //Master ADS chip select port

#define ADS_PWDN_PIN	5  //Master ADS chip select pin
#define ADS_PWDN_PORT   2  //Master ADS chip select port
